...
class App{
	...
	createList(){
		...
		let content = {"platenumber":a.value,"timein":b.value,"timeout":c.value,"image":d.value};
			...
			`
				...
				<div class="media">
				    ...
				    <div class="media-body" id="listDetailsInfo">
						...
						<button class="btn btn-default" onclick="component.showList()">Back</button>
					</div>	
				</div>			
	...
	listCreate(){
		this.render(
			`
				...
				<button class="btn btn-danger" onclick="component.createList()">Create</button><hr>
